...
{$IFOPT D-} {Don't Patch System.Move while Debugging}
...
var
  PrefetchLimit : Integer; {Used within SSE Moves}
...
asm
  ...
  push    ebx
  mov     ebx, edx
  db $0F,$6F,$00             /// movq    mm0, [eax] {First 8 Bytes}
  ...
  nop {Align Loop}
@@FwdLoopMMX:
  db $0F,$6F,$4C,$08,$E0     /// movq    mm1, [eax+ecx-32]
  db $0F,$6F,$54,$08,$E8     /// movq    mm2, [eax+ecx-24]
  db $0F,$6F,$5C,$08,$F0     /// movq    mm3, [eax+ecx-16]
  db $0F,$6F,$64,$08,$F8     /// movq    mm4, [eax+ecx- 8]
  db $0F,$7F,$4C,$0A,$E0     /// movq    [edx+ecx-32], mm1
  db $0F,$7F,$54,$0A,$E8     /// movq    [edx+ecx-24], mm2
  db $0F,$7F,$5C,$0A,$F0     /// movq    [edx+ecx-16], mm3
  db $0F,$7F,$64,$0A,$F8     /// movq    [edx+ecx- 8], mm4
  add     ecx, 32
  jle     @@FwdLoopMMX
  db $0F,$7F,$03             /// movq    [ebx], mm0 {First 8 Bytes}
  db $0F,$77                 /// emms
  pop     ebx
  neg     ecx
  add     ecx, 32
...
@@MMXcopyloop:
   ...
   db $0F,$6F,$4C,$06,$08     /// movq    mm1, [esi+eax+ 8]
   db $0F,$6F,$54,$06,$10     /// movq    mm2, [esi+eax+16]
   db $0F,$6F,$5C,$06,$18     /// movq    mm3, [esi+eax+24]
   db $0F,$6F,$64,$06,$20     /// movq    mm4, [esi+eax+32]
   db $0F,$6F,$6C,$06,$28     /// movq    mm5, [esi+eax+40]
   db $0F,$6F,$74,$06,$30     /// movq    mm6, [esi+eax+48]
   db $0F,$6F,$7C,$06,$38     /// movq    mm7, [esi+eax+56]
   db $0F,$7F,$04,$07         /// movq    [edi+eax   ], mm0
   db $0F,$7F,$4C,$07,$08     /// movq    [edi+eax+ 8], mm1
   db $0F,$7F,$54,$07,$10     /// movq    [edi+eax+16], mm2
   db $0F,$7F,$5C,$07,$18     /// movq    [edi+eax+24], mm3
   db $0F,$7F,$64,$07,$20     /// movq    [edi+eax+32], mm4
   db $0F,$7F,$6C,$07,$28     /// movq    [edi+eax+40], mm5
   db $0F,$7F,$74,$07,$30     /// movq    [edi+eax+48], mm6
   db $0F,$7F,$7C,$07,$38     /// movq    [edi+eax+56], mm7
  add     eax, 64
  jnz     @@MMXcopyloop
...
asm
  ...
  push    ebx
   db $0F,$6F,$44,$08,$F8     /// movq    mm0, [eax+ecx-8] {Get Last QWORD}
...
@@BwdLoopMMX:
  ...
  sub     ecx, 32
  jge     @@BwdLoopMMX
   db $0F,$7F,$44,$1A,$F8     /// movq    [edx+ebx-8], mm0 {Last QWORD}
   db $0F,$77                 /// emms
  add     ecx, 32
  pop     ebx
...
@@Loop:
   ...
   db $0F,$28,$54,$08,$20     /// movaps  xmm2, [eax+ecx+32]
   db $0F,$28,$5C,$08,$30     /// movaps  xmm3, [eax+ecx+48]
   db $0F,$29,$04,$0A         /// movaps  [edx+ecx], xmm0
   db $0F,$29,$4C,$0A,$10     /// movaps  [edx+ecx+16], xmm1
   db $0F,$29,$54,$0A,$20     /// movaps  [edx+ecx+32], xmm2
   db $0F,$29,$5C,$0A,$30     /// movaps  [edx+ecx+48], xmm3
   db $0F,$28,$64,$08,$40     /// movaps  xmm4, [eax+ecx+64]
   db $0F,$28,$6C,$08,$50     /// movaps  xmm5, [eax+ecx+80]
   db $0F,$28,$74,$08,$60     /// movaps  xmm6, [eax+ecx+96]
   db $0F,$28,$7C,$08,$70     /// movaps  xmm7, [eax+ecx+112]
   db $0F,$29,$64,$0A,$40     /// movaps  [edx+ecx+64], xmm4
   db $0F,$29,$6C,$0A,$50     /// movaps  [edx+ecx+80], xmm5
   db $0F,$29,$74,$0A,$60     /// movaps  [edx+ecx+96], xmm6
   db $0F,$29,$7C,$0A,$70     /// movaps  [edx+ecx+112], xmm7
  add     ecx, 128
  js      @@Loop
...
asm
@@Loop:
   db $0F,$10,$04,$08         /// movups  xmm0, [eax+ecx]
   db $0F,$10,$4C,$08,$10     /// movups  xmm1, [eax+ecx+16]
   db $0F,$10,$54,$08,$20     /// movups  xmm2, [eax+ecx+32]
   db $0F,$10,$5C,$08,$30     /// movups  xmm3, [eax+ecx+48]
   db $0F,$29,$04,$0A         /// movaps  [edx+ecx], xmm0
   db $0F,$29,$4C,$0A,$10     /// movaps  [edx+ecx+16], xmm1
   db $0F,$29,$54,$0A,$20     /// movaps  [edx+ecx+32], xmm2
   db $0F,$29,$5C,$0A,$30     /// movaps  [edx+ecx+48], xmm3
   db $0F,$10,$64,$08,$40     /// movups  xmm4, [eax+ecx+64]
   db $0F,$10,$6C,$08,$50     /// movups  xmm5, [eax+ecx+80]
   db $0F,$10,$74,$08,$60     /// movups  xmm6, [eax+ecx+96]
   db $0F,$10,$7C,$08,$70     /// movups  xmm7, [eax+ecx+112]
   db $0F,$29,$64,$0A,$40     /// movaps  [edx+ecx+64], xmm4
   db $0F,$29,$6C,$0A,$50     /// movaps  [edx+ecx+80], xmm5
   db $0F,$29,$74,$0A,$60     /// movaps  [edx+ecx+96], xmm6
   db $0F,$29,$7C,$0A,$70     /// movaps  [edx+ecx+112], xmm7
...
asm
@@Loop:
   db $0F,$18,$04,$08         /// prefetchnta [eax+ecx+Prefetch]
   db $0F,$18,$04,$08         /// prefetchnta [eax+ecx+Prefetch+64]
   db $0F,$28,$04,$08         /// movaps  xmm0, [eax+ecx]
   db $0F,$28,$4C,$08,$10     /// movaps  xmm1, [eax+ecx+16]
   db $0F,$28,$54,$08,$20     /// movaps  xmm2, [eax+ecx+32]
   db $0F,$28,$5C,$08,$30     /// movaps  xmm3, [eax+ecx+48]
   ...
   db $0F,$2B,$54,$0A,$20     /// movntps [edx+ecx+32], xmm2
   db $0F,$2B,$5C,$0A,$30     /// movntps [edx+ecx+48], xmm3
   db $0F,$28,$64,$08,$40     /// movaps  xmm4, [eax+ecx+64]
   db $0F,$28,$6C,$08,$50     /// movaps  xmm5, [eax+ecx+80]
   db $0F,$28,$74,$08,$60     /// movaps  xmm6, [eax+ecx+96]
   db $0F,$28,$7C,$08,$70     /// movaps  xmm7, [eax+ecx+112]
   db $0F,$2B,$64,$0A,$40     /// movntps [edx+ecx+64], xmm4
   db $0F,$2B,$6C,$0A,$50     /// movntps [edx+ecx+80], xmm5
   db $0F,$2B,$74,$0A,$60     /// movntps [edx+ecx+96], xmm6
   db $0F,$2B,$7C,$0A,$70     /// movntps [edx+ecx+112], xmm7
  add     ecx, 128
  js      @@Loop
   db $0F,$AE,$F8             /// sfence
...
@@Remainder:
  ...
  neg     ebx
@@RemainderLoop:
   db $0F,$10,$04,$18         /// movups  xmm0, [eax+ebx]
   db $0F,$29,$04,$1A         /// movaps  [edx+ebx], xmm0
  add     ebx, 16
  jnz     @@RemainderLoop
@@Done:
  pop     ebx
...
asm
  ...
  cmp     ecx, LARGESIZE
  jge     @@FwdLargeMove
   db $0F,$10,$00             /// movups  xmm0, [eax] {First 16 Bytes}
  mov     ebx, edx
...
@@FwdLoopSSE:
  ...
  add     ecx, 32
  jle     @@FwdLoopSSE
   db $0F,$11,$03             /// movups  [ebx], xmm0 {First 16 Bytes}
  neg     ecx
  add     ecx, 32
  pop     ebx
  jmp     SmallForwardMove_10
...
asm
  ...
  push    ebx
   db $0F,$10,$44,$08,$F0     /// movups  xmm0, [eax+ecx-16] {Last 16 Bytes}
...
@@BwdLoop:
  ...
  sub     ecx, 32
  jge     @@BwdLoop
   db $0F,$11,$44,$1A,$F0     /// movups  [edx+ebx-16], xmm0  {Last 16 Bytes}
  add     ecx, 32
  pop     ebx
  jmp     SmallBackwardMove_10
end; {Backwards_SSE}
...
(*  if isSSE3 in CPU.InstructionSupport then
  ...
  PrefetchLimit := CPU.L2CacheSize * -512; {Used within SSE Based Moves}
{$ENDIF}
